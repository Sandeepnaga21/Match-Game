...
class MatchGame extends Component {
  ...
  render() {
    ...
    const {score, time, activeTabId} = this.state
        ...
        <div className="display-container">
          <ul>
            {imagesList.map(eachOne => (
              <li>
                <img src={eachOne.imageUrl} alt={eachOne.category} />
              </li>
            ))}
          </ul>
        </div>
        <div className="tabs-container">
          <ul>
            {tabsList.map(eachTab => (
              <li>
                <button className="tabs" onClick={this.updateActiveTabId}>
                  {eachTab.displayText}
                </button>
              </li>
            ))}
        ...
        <div className="tumbnail-img-conatiner">
          <ul>
            {filteredImages.map(each => (
              <li key={each.id}>
                <img src={each.thumbnailUrl} onClick={this.onClickImg} />
              </li>
            ))}
          </ul>
        </div>
